 ...
 */
  ...
  CheckIsHumanReadName(key?: string): boolean {
    return sessionStorage.getItem(key || 'IsHumanReadName') === 'true';
  }
  ...
  CheckIsReadName(key?: string): boolean {
    return sessionStorage.getItem(key || 'isRealName') === 'true';
  }
  ...
  CheckIsCompanyAccount(key?: string): boolean {
    return sessionStorage.getItem(key || 'isCompanyAccount') === 'true';
  }
